package com.kunika.kscan.libraries;
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints())) {
                     //   ImageCrop.btnImageEnhance.setEnabled(true);
                    //    ImageCrop.btnImageEnhance.setBackgroundColor(getResources().getColor(R.color.blue));
                        color = getResources().getColor(R.color.blue);
                    } else {
                        Toast.makeText(context, "Points are not Valid", Toast.LENGTH_LONG).show();
                    //    ImageCrop.btnImageEnhance.setEnabled(false);
                    //    ImageCrop.btnImageEnhance.setBackgroundColor(getResources().getColor(R.color.orange));
